...
using Digst.OioIdws.Transformers;
    ...
    public class XmlSignatureUtils
    {
        ...
        public static XDocument SignDocument(XDocument xDoc, IEnumerable<string> ids, X509Certificate2 cert)
        {
            ...
            var referenceElement = doc.CreateElement(SignatureCaseMessageTransformer.WssePrefix,
                "Reference",
                SignatureCaseMessageTransformer.WsseNamespace);
            ...
            nsManager.AddNamespace(SignatureCaseMessageTransformer.WssePrefix, SignatureCaseMessageTransformer.WsseNamespace);
        ...
        {
            // This conversion is not as effective as using xDocument.CreateReader().
