...
namespace Digst.OioIdws.WscLocalSignatureBearerToken.Connected_Services.HelloWorldProxy {
    ...
    public interface IHelloWorld {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHelloWorld/HelloNone", ReplyAction="http://tempuri.org/IHelloWorld/HelloNoneResponse")]
        string HelloNone(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHelloWorld/HelloNone", ReplyAction="http://tempuri.org/IHelloWorld/HelloNoneResponse")]
        System.Threading.Tasks.Task<string> HelloNoneAsync(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHelloWorld/HelloNoneError", ReplyAction="http://tempuri.org/IHelloWorld/HelloNoneErrorResponse")]
