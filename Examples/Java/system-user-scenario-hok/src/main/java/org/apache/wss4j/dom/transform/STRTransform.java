...
// element with an embedded EncryptedData element. The EncryptedData element has the ID
// referenced by the RAR in the RequestSecurityTokenResponse, but we need to dereference
// the parent element for this to work
