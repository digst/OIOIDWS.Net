...
namespace Digst.OioIdws.Test
{
    ...
    public class LibBasTests
    {
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasRequestFailDueToBodyTamperingTest()
        {
            // Arrange
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasRequestFailDueToHeaderMessageIdTamperingTest()
        {
            // Arrange
            _fiddlerApplicationOnBeforeRequest = delegate(Session oS)
            {
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasRequestFailDueToHeaderLibertyFrameworkTamperingTest()
        {
            // Arrange
            _fiddlerApplicationOnBeforeRequest = delegate(Session oS)
            {
                ...
                oS.utilReplaceInRequest("<Framework", "<Framework attribute=\"tampered\"");
            };
            FiddlerApplication.BeforeRequest += _fiddlerApplicationOnBeforeRequest;
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasRequestFailDueToHeaderToTamperingTest()
        {
            // Arrange
            _fiddlerApplicationOnBeforeRequest = delegate(Session oS)
            {
                ...
                oS.utilReplaceInRequest("http://digst.oioidws.wsp:9090/HelloWorld</a:To>",
                    "http://digst.oioidws.wsp:9090/HelloWorldTampered</a:To>");
            };
            FiddlerApplication.BeforeRequest += _fiddlerApplicationOnBeforeRequest;
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasRequestFailDueToHeaderSecurityTamperingTest()
        {
            // Arrange
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasRequestFailDueToTokenTamperingTest()
        {
            // Arrange
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasResponseFailDueToBodyTamperingTest()
        {
            // Arrange
            ...
            _fiddlerApplicationOnBeforeResponse = delegate(Session oS)
            {
                ...
                oS.utilReplaceInResponse("Hello Sign Schultz", "Tampered");
            };
            FiddlerApplication.BeforeResponse += _fiddlerApplicationOnBeforeResponse;
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasResponseFailDueToHeaderMessageIdTamperingTest()
        {
            // Arrange
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasResponseFailDueToHeaderRelatesToTamperingTest()
        {
            // Arrange
        ...
        [TestMethod]
        [TestCategory(Constants.IntegrationTest)]
        public void LibBasResponseFailDueToHeaderSecurityTamperingTest()
        {
            // Arrange
            ...
            {
                // Assert
                Assert.AreEqual("Message security verification failed.", mse.Message);
                var ce = mse.InnerException as CryptographicException;
                Assert.IsNotNull(ce, "Expected inner fault exception");
                Assert.IsTrue(ce.Message.StartsWith("Digest verification failed for Reference"));
            }
