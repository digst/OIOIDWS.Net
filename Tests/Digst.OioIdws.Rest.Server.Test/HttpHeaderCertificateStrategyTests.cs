...
namespace Digst.OioIdws.Rest.Server.Test
{
    ...
    public class HttpHeaderCertificateStrategyTests
    {
        [TestMethod]
        public async Task GetCertificate_ReturnsCertificate_FromHeader()
        {
            ...
            var strategy = new HttpHeaderCertificateStrategy();
            var result = await strategy.GetCertificate(contextMock);
        ...
        public async Task GetCertificate_InvalidOperationException_WhenHeaderInvalid()
        {
            ...
            var strategy = new HttpHeaderCertificateStrategy();
            await strategy.GetCertificate(endpointContext);
        }
        
        [TestMethod]
        public async Task GetCertificate_UsesOnly_AllowedHeaders()
        {
            var cert = new X509Certificate2(Convert.FromBase64String(""));
            string base64 = Convert.ToBase64String(cert.Export(X509ContentType.Cert));
